...
{
  private:
    std::stack<std::unique_ptr<sonnx::ASTNode>> m_stack;
  ...
  public:
    auto getTop() -> std::unique_ptr<sonnx::ASTNode>
    {
        auto result = std::move(m_stack.top());
        m_stack.pop();
        return result;
    }

    void visitErrorNode(antlr4::tree::ErrorNode *node) override;
    void exitModel_body_def(antlr_sonnx::S_ONNXParser::Model_body_defContext *ctx) override;
    ...
    void exitGraph_body_def(antlr_sonnx::S_ONNXParser::Graph_body_defContext *ctx) override;
    ...
    void exitTensor_type_def(antlr_sonnx::S_ONNXParser::Tensor_type_defContext *ctx) override;
    ...
    void exitOpset_import_def(antlr_sonnx::S_ONNXParser::Opset_import_defContext *ctx) override;
